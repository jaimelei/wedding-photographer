  ...
  return (
    <div className="relative bg-hero bg-cover bg-center h-[85vh] flex">
      <div className="w-[70%] mx-auto my-32">
        ...
        {/* BANNER SECTION */}
        <div className="absolute left-1/2 -translate-x-1/2 -bottom-[4.5rem] w-[70%] h-[150px] bg-[#f7e6d7] shadow-xl rounded-xl flex items-center justify-center border-2 border-black">
